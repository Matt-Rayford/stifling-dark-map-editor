 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query RetailAccount {\n  retailAccount: getRetailAccount {\n    id\n    name\n    verified\n    rejected\n  }\n}\n\nquery FullRetailAccount {\n  retailAccount: getRetailAccount {\n    id\n    name\n    verified\n    rejected\n    addresses {\n      id\n      city\n      name\n      state\n      streetAddress\n      postalCode\n      contact {\n        id\n        emailAddress\n        name\n        phoneNumber\n      }\n    }\n  }\n}\n\nquery RetailAccountsToVerify {\n  retailAccounts: retailAccountsToVerify {\n    id\n    name\n    taxId\n    verified\n    rejected\n    addresses {\n      id\n      city\n      name\n      state\n      streetAddress\n      postalCode\n      contact {\n        id\n        emailAddress\n        name\n        phoneNumber\n      }\n    }\n  }\n}\n\nmutation RequestRetailAccount($retailAccountInfo: RetailAccountInput!, $addressInfo: RetailPropertyInput!) {\n  retailAccount: requestRetailAccount(\n    retailAccountInfo: $retailAccountInfo\n    addressInfo: $addressInfo\n  ) {\n    id\n    name\n    verified\n    rejected\n  }\n}\n\nmutation UpdateRetailAccountApproval($id: ID!, $approval: Approval!) {\n  updateRetailAccountApproval(id: $id, approval: $approval) {\n    id\n    name\n    taxId\n    verified\n    rejected\n    addresses {\n      id\n      city\n      name\n      state\n      streetAddress\n      postalCode\n      contact {\n        id\n        emailAddress\n        name\n        phoneNumber\n      }\n    }\n  }\n}"): (typeof documents)["query RetailAccount {\n  retailAccount: getRetailAccount {\n    id\n    name\n    verified\n    rejected\n  }\n}\n\nquery FullRetailAccount {\n  retailAccount: getRetailAccount {\n    id\n    name\n    verified\n    rejected\n    addresses {\n      id\n      city\n      name\n      state\n      streetAddress\n      postalCode\n      contact {\n        id\n        emailAddress\n        name\n        phoneNumber\n      }\n    }\n  }\n}\n\nquery RetailAccountsToVerify {\n  retailAccounts: retailAccountsToVerify {\n    id\n    name\n    taxId\n    verified\n    rejected\n    addresses {\n      id\n      city\n      name\n      state\n      streetAddress\n      postalCode\n      contact {\n        id\n        emailAddress\n        name\n        phoneNumber\n      }\n    }\n  }\n}\n\nmutation RequestRetailAccount($retailAccountInfo: RetailAccountInput!, $addressInfo: RetailPropertyInput!) {\n  retailAccount: requestRetailAccount(\n    retailAccountInfo: $retailAccountInfo\n    addressInfo: $addressInfo\n  ) {\n    id\n    name\n    verified\n    rejected\n  }\n}\n\nmutation UpdateRetailAccountApproval($id: ID!, $approval: Approval!) {\n  updateRetailAccountApproval(id: $id, approval: $approval) {\n    id\n    name\n    taxId\n    verified\n    rejected\n    addresses {\n      id\n      city\n      name\n      state\n      streetAddress\n      postalCode\n      contact {\n        id\n        emailAddress\n        name\n        phoneNumber\n      }\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
