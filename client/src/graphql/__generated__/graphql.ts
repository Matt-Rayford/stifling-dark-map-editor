...
export type FullRetailAccountQuery = { __typename?: 'Query', retailAccount?: { __typename?: 'RetailAccount', id: string, name: string, verified: boolean, rejected: boolean, addresses: Array<{ __typename?: 'RetailAddress', id: string, city: string, name?: string | null, state?: string | null, streetAddress: string, postalCode: string, contact: { __typename?: 'Contact', id: string, emailAddress: string, name: string, phoneNumber: string } }> } | null };

export type RetailAccountsToVerifyQueryVariables = Exact<{ [key: string]: never; }>;


export type RetailAccountsToVerifyQuery = { __typename?: 'Query', retailAccounts?: Array<{ __typename?: 'RetailAccount', id: string, name: string, taxId: string, verified: boolean, rejected: boolean, addresses: Array<{ __typename?: 'RetailAddress', id: string, city: string, name?: string | null, state?: string | null, streetAddress: string, postalCode: string, contact: { __typename?: 'Contact', id: string, emailAddress: string, name: string, phoneNumber: string } }> }> | null };
...
export type UpdateRetailAccountApprovalMutation = { __typename?: 'Mutation', updateRetailAccountApproval?: { __typename?: 'RetailAccount', id: string, name: string, taxId: string, verified: boolean, rejected: boolean, addresses: Array<{ __typename?: 'RetailAddress', id: string, city: string, name?: string | null, state?: string | null, streetAddress: string, postalCode: string, contact: { __typename?: 'Contact', id: string, emailAddress: string, name: string, phoneNumber: string } }> } | null };
